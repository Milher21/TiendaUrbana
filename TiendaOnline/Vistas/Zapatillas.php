...
<body>
    ...
    <body>
        ...
        <h2 class="pmv">ZAPATILLAS</h2>
      
            <div class="container-pro">   
                <?php foreach( $Listar ->zapatillas as $row) {?>        
                        ...
                        <?php if(($row['imagen_producto']==null)){
                         ...
                         <?php } else{?>  
                            ...
                            <div class="producto-caracteristicas">
                                <h5 style = "text-align:right" class="titulo-producto"><?php echo $row['nombre_producto']; ?></h5>
